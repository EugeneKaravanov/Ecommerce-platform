...
namespace OrderService.Migrations
{
    public static class SQLMethods
    {
        public static List<string> GetSQLCommandsToCreateNewBucket(int bucketId)
        {
            ...
            SQLCommands.Add($"CREATE TABLE Bucket{bucketId}.OrderItems (Id SERIAL PRIMARY KEY, OrderId INT REFERENCES orders(id), ProductId INT, Quantity INT, UnitPrice DECIMAL);");
